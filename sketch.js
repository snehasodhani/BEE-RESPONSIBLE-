...
beeWinImg=loadImage("images/beeWin.png");
...
restart2Img=loadImage("images/restart2.png");
...
beeWin=createSprite(width/2+330,height/2-20);
beeWin.addImage(beeWinImg);
beeWin.visible=false;
...
bee.visible=false;
  ...
  if(score===100 && gameState==="play"){
   gameState="restart"
   restart2=createSprite(width/2,height/2+100);
...
spawnPathogens();
   ...
   //   flower6.visible=false;
    ...
    bee.y=170;
    bee.velocityY=2;
    bee.changeAnimation("honeybee",beeAnime)
